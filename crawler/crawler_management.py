...
if __name__ == '__main__':
    upid = '64850169'
    # mongo_persist = CsvPersist(mode="excel")
    #
    # pd_bvid = get_v_list_data(upid, mongo_persist)
    headers = {
    ...
    # url_tools.http2json("")
    a = requests.get("https://www.bilibili.com/video/BV1Py4y1E7zy", headers)
    result = a.text
    bs = BeautifulSoup(result, 'html.parser')

    # d = bs.findChild(name='div', attrs={"id": "mw-pages"})
    # d.findChild(name='div', attrs={"class": "mw-category"})



    #https://api.bilibili.com/x/web-interface/archive/stat?bvid=BV1Vp4y1b77r